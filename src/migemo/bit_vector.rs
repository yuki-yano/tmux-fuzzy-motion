...
impl BitVector {
    ...
    pub fn rank(&self, pos: usize, b: bool) -> usize {
        ...
        let mut count1 =
            self.sb[(pos / 64) as usize] as usize + self.lb[(pos / 512) as usize] as usize;
    ...
    pub fn select(&self, count: usize, b: bool) -> usize {
        ...
        let sb_index = self.lower_bound_binary_search_sb(
            count_in_lb as u16,
            lb_index as usize * 8,
            lb_index as usize * 8 + 8,
            b,
        ) - 1;
    ...
    fn lower_bound_binary_search_sb(
        &self,
        key: u16,
        from_index: usize,
        to_index: usize,
...
mod tests {
    ...
    fn test_select_in_word_edge_cases() {
        ...
        for &word in &cases {
            ...
            for count in 1..=pop {
                assert_eq!(
                    select_in_word_ref(word, count),
                    BitVector::select_in_word(word, count)
                );
            }
        }
    }
    ...
    fn test_next_clear_bit() {
        ...
        for i in 0..=SIZE {
            assert_eq!(
                next_clear_bit(&bits, i),
                bitvector.next_clear_bit(i) as usize
            );
        }
    }
}
